...
gd.survival.tier11Waves = {}


-- Waves 101 through 110 for Survival Mode
...
local survivalModeEventEventKey = "SURVIVALMODE_EVENT11"
...
local spawnPoint01wave01Proxies = {nil}
local spawnPoint02wave01Proxies = {"records/proxies/tier11waves/proxy_w01_p02a.dbr"}
local spawnPoint03wave01Proxies = {"records/proxies/tier11waves/proxy_w01_p03a.dbr"}
local spawnPoint04wave01Proxies = {"records/proxies/tier11waves/proxy_w01_p04a.dbr"}
local spawnPoint05wave01Proxies = {"records/proxies/tier11waves/proxy_w01_p05a.dbr"}
local spawnPoint06wave01Proxies = {"records/proxies/tier11waves/proxy_w01_p06a.dbr"}

local spawnPoint01wave02Proxies = {"records/proxies/tier11waves/proxy_w02_p01a.dbr"}
local spawnPoint02wave02Proxies = {"records/proxies/tier11waves/proxy_w02_p02a.dbr"}
local spawnPoint03wave02Proxies = {"records/proxies/tier11waves/proxy_w02_p03a.dbr"}
local spawnPoint04wave02Proxies = {nil}
local spawnPoint05wave02Proxies = {nil}
local spawnPoint06wave02Proxies = {"records/proxies/tier11waves/proxy_w02_p06a.dbr"}

local spawnPoint01wave03Proxies = {"records/proxies/tier11waves/proxy_w03_p01a.dbr"}
local spawnPoint02wave03Proxies = {"records/proxies/tier11waves/proxy_w03_p02a.dbr"}
local spawnPoint03wave03Proxies = {"records/proxies/tier11waves/proxy_w03_p03a.dbr"}
local spawnPoint04wave03Proxies = {"records/proxies/tier11waves/proxy_w03_p04a.dbr"}
local spawnPoint05wave03Proxies = {"records/proxies/tier11waves/proxy_w03_p05a.dbr"}
local spawnPoint06wave03Proxies = {"records/proxies/tier11waves/proxy_w03_p06a.dbr"}

local spawnPoint01wave04Proxies = {nil}
local spawnPoint02wave04Proxies = {nil}
local spawnPoint03wave04Proxies = {"records/proxies/tier11waves/proxy_w04_p03a.dbr"}
local spawnPoint04wave04Proxies = {"records/proxies/tier11waves/proxy_w04_p04a.dbr"}
local spawnPoint05wave04Proxies = {nil}
local spawnPoint06wave04Proxies = {nil}

local spawnPoint01wave05Proxies = {"records/proxies/tier11waves/proxy_w05_p01a.dbr"}
local spawnPoint02wave05Proxies = {"records/proxies/tier11waves/proxy_w05_p02a.dbr"}
local spawnPoint03wave05Proxies = {"records/proxies/tier11waves/proxy_w05_p03a.dbr"}
local spawnPoint04wave05Proxies = {"records/proxies/tier11waves/proxy_w05_p04a.dbr"}
local spawnPoint05wave05Proxies = {nil}
local spawnPoint06wave05Proxies = {nil}

local spawnPoint01wave06Proxies = {nil}
local spawnPoint02wave06Proxies = {"records/proxies/tier11waves/proxy_w06_p02a.dbr"}
local spawnPoint03wave06Proxies = {"records/proxies/tier11waves/proxy_w06_p03a.dbr"}
local spawnPoint04wave06Proxies = {"records/proxies/tier11waves/proxy_w06_p04a.dbr"}
local spawnPoint05wave06Proxies = {nil}
local spawnPoint06wave06Proxies = {"records/proxies/tier11waves/proxy_w06_p06a.dbr"}

local spawnPoint01wave07Proxies = {"records/proxies/tier11waves/proxy_w07_p01a.dbr"}
local spawnPoint02wave07Proxies = {"records/proxies/tier11waves/proxy_w07_p02a.dbr"}
local spawnPoint03wave07Proxies = {"records/proxies/tier11waves/proxy_w07_p03a.dbr"}
local spawnPoint04wave07Proxies = {"records/proxies/tier11waves/proxy_w07_p04a.dbr"}
local spawnPoint05wave07Proxies = {"records/proxies/tier11waves/proxy_w07_p05a.dbr"}
local spawnPoint06wave07Proxies = {nil}

local spawnPoint01wave08Proxies = {"records/proxies/tier11waves/proxy_w08_p01a.dbr"}
local spawnPoint02wave08Proxies = {"records/proxies/tier11waves/proxy_w08_p02a.dbr"}
local spawnPoint03wave08Proxies = {"records/proxies/tier11waves/proxy_w08_p03a.dbr"}
local spawnPoint04wave08Proxies = {"records/proxies/tier11waves/proxy_w08_p04a.dbr"}
local spawnPoint05wave08Proxies = {nil}
local spawnPoint06wave08Proxies = {"records/proxies/tier11waves/proxy_w08_p06a.dbr"}

local spawnPoint01wave09Proxies = {"records/proxies/tier11waves/proxy_w09_p01a.dbr"}
local spawnPoint02wave09Proxies = {"records/proxies/tier11waves/proxy_w09_p02a.dbr"}
local spawnPoint03wave09Proxies = {"records/proxies/tier11waves/proxy_w09_p03a.dbr"}
local spawnPoint04wave09Proxies = {"records/proxies/tier11waves/proxy_w09_p04a.dbr"}
local spawnPoint05wave09Proxies = {"records/proxies/tier11waves/proxy_w09_p05a.dbr"}
local spawnPoint06wave09Proxies = {"records/proxies/tier11waves/proxy_w09_p06a.dbr"}

local spawnPoint01wave10Proxies = {"records/proxies/tier11waves/proxy_w10_p01a.dbr"}
local spawnPoint02wave10Proxies = {"records/proxies/tier11waves/proxy_w10_p02a.dbr"}
local spawnPoint03wave10Proxies = {"records/proxies/tier11waves/proxy_w10_p03a.dbr"}
local spawnPoint04wave10Proxies = {"records/proxies/tier11waves/proxy_w10_p04a.dbr"}
...
function gd.survival.tier11Waves.spawnPoint01OnAddToWorld(objectId)
...
function gd.survival.tier11Waves.spawnPoint01OnRemoveFromWorld(objectId)
...
function gd.survival.tier11Waves.startSurvivalModeEvent()
